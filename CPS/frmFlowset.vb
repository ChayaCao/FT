...
Public Class frmFlowset
    ...
    cb09.DropDown, cb10.DropDown, cb11.DropDown, cb12.DropDown, cb13.DropDown, cb14.DropDown, cb15.DropDown, cb16.DropDown, cb17.DropDown, cb18.DropDown, cb19.DropDown, cb20.DropDown
        ...
        cbarray(sender.tabindex - 1).Items.Add("FT1")
        cbarray(sender.tabindex - 1).Items.Add("FT2")
        cbarray(sender.tabindex - 1).Items.Add("FT3")
        cbarray(sender.tabindex - 1).Items.Add("FT4")
        cbarray(sender.tabindex - 1).Items.Add("FT5")
        cbarray(sender.tabindex - 1).Items.Add("FT6")
        cbarray(sender.tabindex - 1).Items.Add("FT7")
        cbarray(sender.tabindex - 1).Items.Add("FT8")
        cbarray(sender.tabindex - 1).Items.Add("FT9")
        cbarray(sender.tabindex - 1).Items.Add("QC1")
        cbarray(sender.tabindex - 1).Items.Add("QC2")
        cbarray(sender.tabindex - 1).Items.Add("QC3")
        cbarray(sender.tabindex - 1).Items.Add("QC4")
        cbarray(sender.tabindex - 1).Items.Add("QC5")
        cbarray(sender.tabindex - 1).Items.Add("QC6")
        cbarray(sender.tabindex - 1).Items.Add("QC7")
        cbarray(sender.tabindex - 1).Items.Add("QC8")
        cbarray(sender.tabindex - 1).Items.Add("QC9")
        cbarray(sender.tabindex - 1).Items.Add("T/R")



        cbarray(sender.tabindex - 1).Items.Add("IQC")
        cbarray(sender.tabindex - 1).Items.Add("SCAN/VM")
        cbarray(sender.tabindex - 1).Items.Add("OQC")

        cbarray(sender.tabindex - 1).Items.Add("BAKE")
